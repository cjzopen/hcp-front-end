...
<body>
	...
	<table border="0" cellpadding="0" cellspacing="0"><tr>
      <td><div style="font-size: 70px; height:75px; display: inline-block; color:#69F; font-family:'微軟正黑體'">加班待簽核</div> </td> <td><div style="text-align:right;"><a href="<?php echo base_url()?>index.php/menu"><img src="<?php echo base_url()?>img/previous3.png" width="450" height="85" alt="pev"></a></div></td>
	  </tr></table>
	  </div>  <br/>
 <div class="page__content-container">
      <?php 
	       ...
	       echo form_open('ovt_approve',$attributes) ;
	  ?>
	 ...
	 <?php  
	  ...
	  <?php   
			 ...
			 ?>	 		  
              <tr>
                <th colspan="1"><div style="font-size: 45px; height:45px; display: inline-block;text-align:center;vertical-align:middle;margin-top:10px;">駁回原因<div></th>
                <td colspan="3">
