...
class DHTML_Calendar {
    ...
    function DHTML_Calendar($calendar_lib_path = '/calendar/',
        ...
        $this->calendar_theme_file = 'theme/'.$theme.'.css';
    ...
    function make_input_field($cal_options = array(), $field_attributes = array()) {
        ...
        echo '<a href="#" id="'. $this->_trigger_id($id) . '">' .
            '<img valign="middle" border="0" src="' . $this->calendar_lib_path . 'img.gif" alt="" /></a>';
...
<HTML>
 <HEAD>
  ...
  <?php $cal = new DHTML_Calendar('',
                            'zh_CN',
                           'Aqua');$cal->load_files();?>
 </HEAD>

 <BODY>
  <?php $cal->make_input_field(array(),array("name"=>"googledate"));?>
 </BODY>
</HTML>