...
;!function() {
    ...
    var e = window.layui && layui.define
      ...
      , n = {
        ...
        ready: function(a) {
            ...
            return "function" == typeof define && define.amd ? a() : (e ? layui.addcss(o, a, i) : t.link(o, a, i),
            this)
        }
    }
      , a = function() {
    ...
    D.prototype.calendar = function(e) {
        ...
        "time" === s.type ? r.setBtnStatus("時間", T.extend({}, r.systemDate(), r.startTime), T.extend({}, r.systemDate(), r.endTime)) : r.setBtnStatus(!0))),
        ...
        "year" === e || "month" === e)
            ...
            T(d).find("ol").each(function(e) {
                ...
                T(t).find("li").on("click", function() {
                    ...
                    T(this).hasClass(s) || (a.range ? n[C][x[e]] = r : i[x[e]] = r,
